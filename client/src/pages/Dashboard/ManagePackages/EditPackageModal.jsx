...
const EditPackageModal = ({ packageData, onClose, onSuccess }) => {
  ...
  const [selectedGuideId, setSelectedGuideId] = useState(packageData.tourGuideId || "");
  ...
  const updatePackageMutation = useMutation({
    mutationFn: async (updateData) => {
      ...
      const finalPackage = {
        ...
        images: imageURLs,
        tourGuideId: selectedGuideId || null,
            ...
            <div>
              ...
              {!guidesLoading && tourGuides.length === 0 && (
                <p className="text-red-500 text-center py-8 font-semibold">
                  No tour guides available. Please add tour guides first before editing packages.
                </p>
              )}
              {selectedGuideId && (
