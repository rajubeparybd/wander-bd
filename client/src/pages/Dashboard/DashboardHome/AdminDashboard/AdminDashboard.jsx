  ...
  return (
    <div className="p-6 space-y-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        <div className="bg-linear-to-r from-blue-500 to-blue-600 text-white rounded-xl shadow-lg p-6">
          <h4 className="text-lg font-semibold">Total Payment</h4>
          <p className="text-2xl font-bold">৳ {stats.totalPayment.toLocaleString()}</p>
        </div>
        <div className="bg-linear-to-r from-green-500 to-green-600 text-white rounded-xl shadow-lg p-6">
          <h4 className="text-lg font-semibold">Tour Guides</h4>
          <p className="text-2xl font-bold">{stats.totalTourGuides}</p>
        </div>
        <div className="bg-linear-to-r from-purple-500 to-purple-600 text-white rounded-xl shadow-lg p-6">
          <h4 className="text-lg font-semibold">Packages</h4>
          <p className="text-2xl font-bold">{stats.totalPackages}</p>
        </div>
        <div className="bg-linear-to-r from-pink-500 to-pink-600 text-white rounded-xl shadow-lg p-6">
          <h4 className="text-lg font-semibold">Clients</h4>
          <p className="text-2xl font-bold">{stats.totalClients}</p>
        </div>
        <div className="bg-linear-to-r from-yellow-500 to-yellow-600 text-white rounded-xl shadow-lg p-6">
